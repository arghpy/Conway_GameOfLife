        ...
        BeginDrawing();
            ...
            for (int i = 1; i < (ROWS - 1); i++) {
                for (int j = 1; j < (COLS - 1); j++) {
                    ...
                    if (grid[i][j].alive == 1 && (cell_alive_counter == 2 || cell_alive_counter == 3)) {
...
void CellDraw(Cell cell)
{
    if (cell.alive == 1) {
        ...
        DrawRectangle(cell.x * cell_width, cell.y * cell_height, cell_width, cell_height, WHITE);
    }
    else if (cell.alive == 0) {
        DrawRectangle(cell.x * cell_width, cell.y * cell_height, cell_width, cell_height, BLACK);
    }
}
